...
const FULL_PRESETS = {
  ...
  minimalistWhite: {
    device: { type: 'iphone16', color: 'white' },
    preset: 'reels', scale: 0.42,
    bg: { type: 'solid', color: '#ffffff', gradient: { enabled:false } },
    shadow: 0.2, lut: null, overlays: [],
    entrance: { type: 'fadeIn', duration: 1000 }, animPreset: 'none',
    particles: { enabled:false }, orbit: { enabled:false },
    text: [{ content: 'Elegance', fontSize: 32, color: '#333333', weight: '300', yPct: 0.1 }],
  },
  gamingPro: {
    device: { type: 'iphone16', color: 'black' },
    preset: 'reels', scale: 0.48,
    bg: { type: 'gradient', color: '#050505', gradient: { enabled:true, color1:'#ff000022', color2:'#000000', color3:'#0000ff22', angle:45, animated:true, speed:0.5 } },
    shadow: 1.0, lut: 'moody', overlays: ['chromatic', 'vignette'],
    entrance: { type: 'rotateIn', duration: 800 }, animPreset: 'glitch',
    particles: { enabled:true, type:'sparkle', count:40, color:'#00f2ff', speed:0.6 },
    orbit: { enabled:true, speed:0.3, range:6 },
    text: [],
  },
  corporatePro: {
    device: { type: 'macbookpro', color: 'silver' },
    preset: 'youtube', scale: 0.55,
    bg: { type: 'gradient', color: '#f0f4f8', gradient: { enabled:true, color1:'#e0eafc', color2:'#cfdef3', color3:'#e0eafc', angle:135, animated:false } },
    shadow: 0.4, lut: 'cinematic', overlays: ['vignette'],
    entrance: { type: 'slideUp', duration: 1000 }, animPreset: 'none',
    particles: { enabled:false }, orbit: { enabled:true, speed:0.05, range:2 },
    text: [{ content: 'Quarterly Review', fontSize: 28, color: '#1a365d', weight: '700', yPct: 0.05 }],
  },
  cleanSocial: {
